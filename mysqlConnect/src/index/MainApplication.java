...
public class MainApplication {
	...
	public static void main(String[] args) {
		...
		if (path.equals("POST /board")) {
			...
			// 실제 비즈니스 로직을 실행하기 위해 Service의 메소드 호출
			...
			//////////////////////////////////////////////////////////
			// 비즈니스 로직을 실행하기 위해 service메소드를 호출
