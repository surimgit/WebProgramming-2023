...
public class Main {
	...
	// 회원 등록
	// id > 0, password, name, telNumber != null && ""
	...
	private User updateUser(UpdateUserDto dto) {
		...
		// 입력받은 password와 해당 유저의 password가 같은지 검증
	...
	// 특정 회원 아이디를 database에서 검색해서 해당 인덱스를 반환하는 메소드
